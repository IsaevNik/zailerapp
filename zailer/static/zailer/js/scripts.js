...
(function($, window, document, undefined) {
    ...
    if (filtersContainer.hasClass('cbp-l-filters-dropdown')) {
        ...
        filtersCallback = function(me) {
            if (me.hasClass('model-level')) {
                var prev = me.siblings(".cbp-filter-item-active");
                $(prev.data('toggle')).slideToggle('slow');
                $('.car-sublevels .sublevel .cbp-filter-item-active').each(function() {
                    $(this).removeClass('cbp-filter-item-active');
                })
                
            }
            if (me.hasClass('has-not-sublevel')) {
                $('.car-sublevels .cbp-filter-item-active').each(function() {
                    $(this).removeClass('cbp-filter-item-active');
                })
                $('.car-sublevels .sublevel').each(function(){
                    $(this).slideUp('fast');
                });
            }
    ...
    filtersContainer.on('click.cbp', '.cbp-filter-item', function() {
        ...
        if (me.hasClass('has-sublevel')) {
            $(me.data('toggle')).slideToggle('slow');
        }
        // filter the items
        gridContainer.cubeportfolio('filter', me.data('filter'), function() {}); ////// <--- filter
